...
class CesniFireModel extends Model
{
    protected $table            = 'cesni_fire';        // Tablonun adı
    ...
    protected $allowedFields    = ['takoz_kodu', 'beklenen_has','cikan_has']; // Kayıt eklerken/güncellerken kullanılabilir alanlar
