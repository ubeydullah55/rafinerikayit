...
*/
    ...
    public function index()
    {
        ...
        $cesniBuilder->select('cesni.*, takozlar.musteri,takozlar.gumus_milyem,takozlar.seri_no, takozlar.giris_gram, takozlar.tahmini_milyem, takozlar.olculen_milyem, takozlar.cesni_has, customer.ad as musteri_adi');
