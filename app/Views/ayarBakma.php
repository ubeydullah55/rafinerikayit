        ...
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30">
                <div class="pd-20" style="display: flex; align-items: center; justify-content: space-between;">
                    <div>
                        <h4 class="text-blue h4">AYAR BAKILANLAR TAKOZ</h4>
                    ...
                    <!-- Sağ tarafa buton -->
                    <div>
                        <form action="<?= site_url('ayarBakmaCesni') ?>" method="get">
                            <button type="submit" class="btn btn-primary">Çeşni Listesi</button>
                        </form>
                    </div>
                </div>
...
<script>
    function onaylaTakoz(takoz_id) {
        $.ajax({
            url: "<?= base_url('ayarBakma/onaylaTakoz') ?>",
            method: "POST",
            data: {
                takoz_id: takoz_id
            },
